...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
  ...
  Future<void> setUpdateUser(String userID,
    ...
    print("uploadPrifile=============${getUpdateUserApi.toString()}");
    print(data.toString());
...
/*  _getDivider() {
  ...
  Future<void> _openStoreListing() => _inAppReview.openStoreListing(
    appStoreId: 'com.giftbash.user',
    microsoftStoreId: "microsoftStoreId"
  );
  _launchURLBrowser() async {
    const url = 'https://play.google.com/store/apps/details?id=com.giftbash.user';
 ...
 // requestReview();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar :  AppBar(backgroundColor: colors.primary,
        leadingWidth: 105, //TODO Adjust leading container width
        leading: Center(
            child: Text(
              'PROFILE',
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Selector<UserProvider, String>(
                        ...
                        builder: (context, profileImage, child) {
                          return Padding(
                            ...
                            child: getUserImage(profileImage, getImage(ImageSource.gallery, context)),
                          );
                        }),
                    Selector<UserProvider, String>(
                        selector: (_, provider) => provider.curUserName,
                    ...
                    Container(
                      child: InkWell(
                          onTap: () => requestPermission(context, 1),
  ...
  Future<void> setProfilePic(File _image) async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        print("nnnnnnnnnnnnnnnnnn${getUpdateUserApi.toString()}");
        print(getUpdateUserApi.toString());
        var pic = await http.MultipartFile.fromPath(IMAGE, _image.path);
        request.files.add(pic);
        if (_image != null) {
          var bankPas =
              await http.MultipartFile.fromPath("bank_pass", _image.path ?? "");
