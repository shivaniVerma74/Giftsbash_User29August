...
class _SendOtpState extends State<SendOtp> with TickerProviderStateMixin {
  ...
  Future<void> getVerifyUser() async {
    ...
    try {
     ...
     print("parararra ${data} url ${getVerifyUserApi}");
      var getdata = json.decode(response.body);
      print("get dattatatat ${getdata}");
      bool? error = getdata["error"];
      String? msg = getdata["message"];
      print("in page navigateee newwwwwww");
      await buttonController!.reverse();
      print("in page navigateee new oneeeee");
      SettingProvider settingsProvider = Provider.of<SettingProvider>(context, listen: false);
      print("in page navigateee newwwwwww");
      if(widget.checkForgot == "false") {
        print("in page navigateeee");
        if (widget.title == getTranslated(context, 'SEND_OTP_TITLE')) {
          if (!error!) {
            print("in page navigateeee --------2");
            ...
            Future.delayed(Duration(seconds: 1)).then((_) {
              print("in page navigateeee333333");
              Navigator.pushReplacement(
              ...
              print("in page navigateeee4444444");
            });
          } else {
            setSnackbar(msg!);
          }
