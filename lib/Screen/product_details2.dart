...
//           onWillPop: back,
//           child: SingleChildScrollView(
//             child:model.addOnList.length == 0 || model.addOnList.length == null?SizedBox.shrink(): Container(
...
//                               //   _controller.add(new TextEditingController());
//                               print("imagesssssssssssssssss${model.addOnList[i].image}");
//                               if(model.addOnList[i].price == '' || model.addOnList[i].price == null){
...
//           Response response =
//           await post(manageCartApi, body: widget.model!.is_customize == "0" ? parameter : parameter, headers: headers)
...
//                         // Divider(),
//                         //  aadon(),
//                         widget.model!.enableIndicator =="0" ? SizedBox.shrink()  :  _sellerDetail(),
//                         widget.model!.same == "0"  ? Padding(
//                           padding: const EdgeInsets.all(8.0),
//                           child: Text("Courier delivered product. Earliest Delivery: 2-4 days",
//                           style: TextStyle(
...
//                           border: Border.all(color: selectedIndex1 == 1 ? colors.primary : colors.secondary,width: 2)
//                       ),
//                       child: Container(
//                         decoration: BoxDecoration(
//                           borderRadius: BorderRadius.circular(100),
//                           color: selectedIndex1 == 1 ? colors.primary : Colors.transparent,
//                         ),
//                       ),
//                     ),
//                     SizedBox(width: 10,),
//                     Row(
//                       children: [
//                         Text("Egg",style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.w500),),
//                         SizedBox(width: 5,),
//                         Container(
//                             height: 20,
...
//                         decoration: BoxDecoration(
//                             borderRadius: BorderRadius.circular(100),
//                             border: Border.all(color: selectedIndex1 == 2 ? colors.primary : colors.secondary,width: 2)
//                         ),
//                         child: Container(
//                           decoration: BoxDecoration(
//                             borderRadius: BorderRadius.circular(100),
//                             color: selectedIndex1 == 2 ? colors.primary : Colors.transparent,
//                           ),
//                         ),
//                       ),
//                       SizedBox(width: 10,),
//                       Row(
//                         children: [
//                           Text("EggLess",style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.w500),),
//                           SizedBox(width: 5,),
//                           Padding(
