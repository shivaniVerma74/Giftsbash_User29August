...
//   Product? product;
//
//   Future getProductDetails(String id, int index) async {
...
//                       print("this is ${productList[index].name}");
...
//         child: getSame!.data!.product!.length == 0? SizedBox.shrink():
//             GridView.builder(
...
//                   crossAxisSpacing: 10
//             ),
//           itemCount: getSame!.data!.product!.length,
...
//                           )),
//                       getSame!.data!.product![index].variants![0].specialPrice == "0" ?
//                       SizedBox.shrink() :
//                       Padding(
//                         padding: const EdgeInsets.only(left: 10),
//                         child: Text("$CUR_CURRENCY " "${getSame!.data!.product![index].variants![0].specialPrice}",style: TextStyle(
...
class StateProduct extends State<SameProduct> with TickerProviderStateMixin {
    ...
    return Scaffold(
        appBar:AppBar(
          ...
          actions: <Widget>[
            ...
            //           ));
            //     }),
            // "SAME DAY" == getTranslated(context, "FAVORITE")
            //     ? Container()
            //     : IconButton(
            //   padding: EdgeInsets.all(0),
            //   icon: SvgPicture.asset(
        ...
        // widget.fromSeller! ? null :
        // getAppBar("SAME DAY", context),
        key: _scaffoldKey,
      ...
      Column(
        children: [
          Container(
            ...
            child: Column(
              children: [
                // if (widget.fromSeller!) Container() else
                  _tags(),
                filterOptions(),
              ],
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  !loading
                    ...
                    onPressed: available!
                        ? () {
                      print("model===${model}index====${index}Addlist====${addIdList}");
