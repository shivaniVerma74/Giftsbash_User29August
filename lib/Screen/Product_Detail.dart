...
/*  _transactionscrollListener() {
  ...
  Widget build(BuildContext context) {
    print(
        "final check here ${widget.model!.addOnList} and ${widget.model!.addOnList!.length}");
    ...
    persistentBottomSheetController =
      ...
      (context) {
        return WillPopScope(
          onWillPop: back,
          child: SingleChildScrollView(
            child: model.addOnList.length == 0 || model.addOnList.length == null
                ? SizedBox.shrink()
                : Container(
...
*/
                              ...
                              onTap: () {
                                ...
                                if (_isProgress == false) {
                                  ...
                                  if (widget.model!.is_customize == "0") {
                                    ...
                                    /*String qty = ((int.parse(qtyController.text)) + 1
                                    ).toString();*/
                ...
                for (int i = 0; i < att.length; i++) {
                  ...
                  if (_selectedIndex[index] != null) if (wholeAtt
                    ...
                    choiceChip = ChoiceChip(
                      ...
                      // onSelected: (bool vlaue){
                      //   available! ? applyVarient : null,
                      // },
                      ...
                      labelPadding: EdgeInsets.only(left: 6, right: 8),
                      //selectedColor: Theme.of(context).colorScheme.fontColor.withOpacity(0.1),
                      shape: RoundedRectangleBorder(
  ...
  applyVarient() {
    ...
    setSnackbar("Variant applied successfully!", context);
  }
  ...
  Future<void> addToCart(
    ...
    if (widget.model!.is_customize == "1") {
      ...
      if (fileDate.isEmpty) {
        ...
        fileDate =
            aadharImage!.path.split("/data/user/0/com.giftbash.user/cache/");
      }
    } else {}
      ...
      if (CUR_USERID != null) {
        try {
          ...
          Response response = await post(manageCartApi,
                  body:
                      widget.model!.is_customize == "0" ? parameter : parameter,
                  headers: headers)
          ...
          String? msg = getdata["message"];
          if (!error) {
            setSnackbar("Product Added to cart successfully!", context);
            var data = getdata["cart"];
            // context.read<UserProvider>().setCartCount(data['cart_count']);
              ...
              children: <Widget>[
                Column(
                  ...
                  children: [
                    Card(
                      elevation: 0,
                      child: widget.model!.type == "variable_product"
                    ...
                    // Divider(),
                    //  aadon(),
                    widget.model!.enableIndicator == "0"
                        ? SizedBox.shrink()
                        : _sellerDetail(),
                    widget.model!.same == "0"
                        ? Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              "Courier delivered product. Earliest Delivery: 2-4 days",
                    ...
                    // Padding(
                    //         padding: const EdgeInsets.all(8.0),
                    //         child: Text("Same day delivery product"),
                    //       ),
                    _specification(),
                    // Divider(),
                ...
                children: [
                  ...
                  Expanded(
                    child: TextButton.icon(
                        ...
                        onPressed: () {
                          if (widget.model!.is_customize == "0") {
                            print("quintityyyy ${widget.model!.qtyStepSize!}");
                            String qty = ((int.parse(qtyController.text)) + 0
                                // (int.parse(widget.model!.qtyStepSize!))
                                ).toString();
                            if (widget.model!.addOnList.length > 0) {
                            ...
                            if (aadharImage == null) {
                              ...
                              print('${widget.model!.qtyStepSize}_________');
                ...
                children: [
                  Container(
                    ...
                    child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.network(
                          "${widget.model!.addOnList[index].image}",
                          fit: BoxFit.fill,
                        )),
                  ),
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "${widget.model!.addOnList[index].name}",
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 16,
                        ...
                        Text(
                            "Price : $CUR_CURRENCY${widget.model!.addOnList[index].price}"),
                        SizedBox(
                          height: 10,
                        ),
                        Card(
                              ...
                              children: [
                                InkWell(
                                    onTap: () {
                                      ...
                                      print(
                                          "checking controller remove ${_controller[index]}");
                                    },
                                    child: Icon(
                                      Icons.remove,
                                      color: Colors.black,
                                ...
                                InkWell(
                                    onTap: () {
                                      ...
                                      print(
                                          "checking controller add ${_controller[index]}");
                                    },
                                    child: Icon(
                                      Icons.add,
                                      color: Colors.black,
...
/*  AddOnModel?  AddOnNew;
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Container(
                        height: 20, child: Image.asset("assets/images/Egg.png"))
                  ],
                )
              ],
            ),
  ...
  //   print('enter Galaryyyyyyyyyyyyyyyyyyy');
  //
  ...
  //         aadharImage = File(pickedFile.path);
  //
  //         print('image======${aadharImage}');
  //
  //       }
  //
  //   } else if (status == PermissionStatus.permanentlyDenied) {
  //     print('permision Deniedddddddddd');
  //   } else {
  //
  //   }
  //
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: <Widget>[
              ...
              InkWell(
                onTap: () async {
                  getCamera(ImageSource.camera, context);
