                ...
                child: Row(
                  ...
                  children: [
                    Text(getTranslated(context, 'AddOn')! + " " + ":",
                        style: Theme.of(context).textTheme.button!.copyWith(
                            color: Theme.of(context).colorScheme.lightBlack2)),
                    widget.model!.addOnTotal == null || widget.model!.addOnTotal == ""?Text("0.0"):Text("+ " + CUR_CURRENCY! + " " + widget.model!.addOnTotal!,
                        style: Theme.of(context).textTheme.button!.copyWith(
                            color: Theme.of(context).colorScheme.lightBlack2))
                  ],
                ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(widget.model!.total==null || widget.model!.total=="" ? "0" : CUR_CURRENCY! + " " + widget.model!.total!,
                        style: Theme.of(context).textTheme.button!.copyWith(
                            color: Theme.of(context).colorScheme.lightBlack,
                            fontWeight: FontWeight.bold))
                  ],
    ...
    return Card(
        ...
        child: Padding(
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Padding(
                  padding: EdgeInsetsDirectional.only(start: 15.0, end: 15.0),
                  child: Text(getTranslated(context, 'SENDER_DETAILS')!,
                      style: Theme.of(context).textTheme.subtitle2!.copyWith(
                          color: Theme.of(context).colorScheme.fontColor,
                          fontWeight: FontWeight.bold))),
              Divider(
              ...
              Padding(
                  padding: EdgeInsetsDirectional.only(start: 15.0, end: 15.0),
                  child: Text(widget.model!.senderMobile!,
                      style: TextStyle(
                        color: Theme.of(context).colorScheme.lightBlack2,
                      ))),
            ])));
