...
//   print("background notification" + message.toString());
// }
//
...
//   print("forground message ${message}");
...
//       playSound: true,
//       // sound: RawResourceAndroidNotificationSound('push'),
...
class PushNotificationService {
  ...
  Future initialise() async {
    ...
    if (deviceInfo.version.sdkInt! > 32) {
      permissionStatus = await Permission.notification
          .request()
          .isGranted;
    } else {
      permissionStatus = await Permission.notification
